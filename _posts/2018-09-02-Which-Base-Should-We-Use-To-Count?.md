...
categories:
excerpt: "Try out addition and subtraction in any base using this game!"
tags:
  - p5js
  - comp1720
  - interactive
...
> To use this demo, you first select which base you want to use by moving the mouse up and down while clicking on the grey box at the far right. After This, you will be given a problem of transferring some amount of coins. To pick up 3 coins from a pile of 5, simply click on the third coin down in the pile. You can place coins down by clicking on the triangle above the pile you wish to add them to. You can convert coins by clicking on the red square under the conversion you wish to perform (it goes both ways, always giving you a different colour than what you started with). 
